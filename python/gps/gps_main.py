...
def main():
	...
	if args.targetsetup:
		...
		plt.legend(['avg LG demo', 'LG demo'], loc='upper right', ncol=2)
		...
		plt.title("mean distances to the target over time with LG demo")
		# plt.title("mean distances to the target during iterations with and without demo init")
		plt.xlabel("iterations")
		plt.ylabel("mean distances")
		plt.savefig(exp_dir + 'mean_dists_during_iteration_comparison_LG.png')
		plt.close()
		...
		plt.title("success rates during iterations with with LG demo")
		# plt.title("success rates during iterations with and without demo initialization")
		plt.savefig(exp_dir + 'success_rate_during_iteration_comparison_LG.png')
		plt.close()
