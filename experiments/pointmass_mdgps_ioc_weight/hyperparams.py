...
density_range = 10**(np.array([-7, -6.5, -6, -5, -4, -3, -2, -1, 0, 1, 1.5, 2, 3, 3.5, 4]))
...
agent = {
    ...
    'models': [weighted_pointmass(target_pos, density=density_range[0], control_limit=10.0),
       ...
       weighted_pointmass(target_pos, density=density_range[13], control_limit=10.0),
       weighted_pointmass(target_pos, density=density_range[14], control_limit=10.0),
       ],
    'density_range': density_range,
    'filename': '',
    #'x0': [np.array([-1., 1., 0., 0.]), np.array([1., 1., 0., 0.]),
    #       np.array([1., -1., 0., 0.]), np.array([-1., -1., 0., 0.])],
    'x0': [np.array([-1., 0., 0., 0.])]*15,
    'dt': 0.05,
    'substeps': 1,
