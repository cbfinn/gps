...
from gps.proto.gps_pb2 import JOINT_ANGLES, JOINT_VELOCITIES, \
        ...
        RGB_IMAGE, RGB_IMAGE_SIZE, DOMAIN_IMAGE, DOMAIN_IMAGE_SIZE
...
SENSOR_DIMS = {
    ...
    RGB_IMAGE_SIZE: 3,
    DOMAIN_IMAGE: IMAGE_WIDTH*IMAGE_HEIGHT*IMAGE_CHANNELS,
    DOMAIN_IMAGE_SIZE: 3,
}
...
agent = {
    ...
    # 'obs_include': [],
    'meta_include': [RGB_IMAGE_SIZE, DOMAIN_IMAGE, DOMAIN_IMAGE_SIZE],
    # 'meta_include': [],
}
