...
TEST_CONDITIONS = 64
xs = np.linspace(lower + 0.01, upper - 0.01, 4)
ys = np.linspace(lower + 0.01, upper - 0.01, 4)
zs = np.linspace(lower + 0.01, upper - 0.01, 4)
test_pos_body_offset = [np.array([x,y,z]) for x in xs for y in ys for z in zs]
