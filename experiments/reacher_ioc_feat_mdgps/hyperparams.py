...
from gps.algorithm.policy_opt.tf_model_example import multi_modal_network, multi_modal_network_fp, example_tf_network
...
# first 5 are the conditions it was trained on.
DEMO_CONDITIONS = 15
...
common = {
    ...
    'data_files_dir': EXP_DIR + 'data_files_redo/',
    ...
    'nn_demo': True,
    'NN_demo_file': EXP_DIR + 'data_files_redo/pol_demos.pkl',
}
...
algorithm = {
    'type': AlgorithmMDGPS,
    'ioc' : 'ICML',
    'sample_on_policy': True, # try with false too.
    'max_ent_traj': 1.0,
    'conditions': common['conditions'],
    'iterations': 35,
    'kl_step': 0.5,
    'min_step_mult': 0.2, #0.5, #0.1,  # 0.2 wasn't working great.
    'max_step_mult': 2.0,
    'policy_sample_mode': 'replace',
    'demo_cond': demo_agent['conditions'],
    'num_demos': 2,
    'demo_var_mult': 1.0,
    'synthetic_cost_samples': 0, #100, # trying out 0 to see if these help. It does! About the same performance and 3x faster.
    'plot_dir': EXP_DIR,
...
config = {
    ...
    'algorithm': algorithm,
    'conditions': common['conditions'],
    # Uncomment below to record videos
    # 'record_gif': {
