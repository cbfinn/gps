...
agent = {
    'type': AgentMuJoCo,
    # 'models': [weighted_reacher(density=1e-10),
    #     weighted_reacher(density=1e-9),
    #     weighted_reacher(density=1e8),
    #     weighted_reacher(density=1e9),
    #     ],
    'models': [weighted_reacher(density=density_range[0]),
        weighted_reacher(density=density_range[1]),
        weighted_reacher(density=density_range[2]),
        weighted_reacher(density=density_range[3]),
        weighted_reacher(density=density_range[4]),
        weighted_reacher(density=density_range[5]),
        weighted_reacher(density=density_range[6]),
        weighted_reacher(density=density_range[7]),
        weighted_reacher(density=density_range[8]),
        weighted_reacher(density=density_range[9]),
        weighted_reacher(density=density_range[10]),
        weighted_reacher(density=density_range[11]),
        weighted_reacher(density=density_range[12]),
        weighted_reacher(density=density_range[13]),
        weighted_reacher(density=density_range[14]),
        ],
